...
import * as PdfRepository from '../repositories/pdf.repository.js';

export const generarReporteTurnos = async () => {
  const turnos = await PdfRepository.obtenerTurnosReporte();
