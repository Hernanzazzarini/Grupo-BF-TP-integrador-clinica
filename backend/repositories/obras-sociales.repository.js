...
export const findDescuentoById = async (id) => {
  const [rows] = await pool.query(
...
export const insert = async ({ nombre, descripcion, porcentaje_descuento, es_particular }) => {
...
export const updateById = async (id, { nombre, descripcion, porcentaje_descuento, es_particular }) => {
  const [result] = await pool.query(
